1. ТЗ в CURSOR НА РАЗРАБОТКУ САЙТА-ПОРТФОЛИО ДЛЯ ВАЙБ-КОДЕРА

 Первый экран

 Заголовок:

Я делаю сайты, интерфейсы и digital-проэкты, которые выглядят как вайб, а работают как система
...
Vibe Coder / Portfolio / Web & Experiences 
...
Я работаю на стыке кода, визуала, UX b AI-инструментов.

Для меня сайт - это нне набор блоков. Это ощущение проекта, ритм, подача, структура и то, как человек чувствует себя внутри интерфейса.
...
Продумываю, как человек читает, уда смотрит, где теряется и где принимает решение.
...
Могу помочь с концепцией, структурой, упаковкой и релизацией.
